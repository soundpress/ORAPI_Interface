...
?>	
	<header class="main_heading">
		<div class="container">
			<h1 class="page-title">New York City’s Government Services</h1>
		</div>
	</header>
	<div class="main_content">
		<div class="container">
			<div class="mt-3 mb-4">
				...
				<p class="body_text">Add text using normal paragraph font style: “This is a directory of the services New York City’s government provides or pays for that are made available as open data following the <a href="http://docs.openreferral.org/en/latest/" target="_blank" >Open Referral Human Services Data Standard</a>. If New York City made all its services available in this format then it would be a lot easier for people to find the help they need. Join our campaign to get NYC to make an exhaustive list of services available to all New Yorkers at <a href="http://2114.nyc/" target="_blank" >2114.nyc</a>.</p>
...
?>	<div class="container-fluid mt-3" id="sGrid">
		<div class="row">
			...
			<?php $this->drawDataActualDateNotification(); ?>
		</div>
	</div>
<?php	
}
...
{
?>	<div class="container pl-4" style="min-height:50vh">
	  <div class="row">
...
?>	
	<header class="site-header">
		...
		<div class="responsive_menu">
			<div class="container">
				<a href="http://wegov.nyc/news/" class="menu_link">News</a>
				<a href="http://wegov.nyc/learn/" class="menu_link">Knowledge</a>
				<a href="http://wegov.nyc/network/" class="menu_link is-active">Network</a>
				<a href="http://research.wegov.nyc/" class="menu_link">Research</a>
				<a href="http://decide.wegov.nyc/legislation/processes" class="menu_link">Decide</a>
				<a href="http://wegov.nyc/act/" class="menu_link">Act</a>
				<a href="http://wegov.nyc/about/" class="menu_link">About</a>
				<a href="http://wegov.nyc/blog/" class="menu_link">Blog</a>
				<a href="https://opencollective.com/mygovnyc" class="menu_link ">Donate</a>
				<a href="http://wegov.nyc/get-involved/" class="menu_link ">Get Involved</a>
			</div>
		</div>
		...
		<div class="main_menu">
			<div class="container">
				<ul class="external_menubar">
					<li><a href='http://wegov.nyc/news/'  class="menu_link">News</a></li>
					<li><a href="http://wegov.nyc/learn/" class="menu_link">Knowledge</a></li>
					<li><a href="http://wegov.nyc/network/" class="menu_link  is-active">Network</a></li>
					<li class="dropdown">
						<a class="dropdown-toggle menu_link" data-toggle="dropdown" href="#">Tools</a>
						<ul class="dropdown-menu">
							<li><a href="http://research.wegov.nyc/" class="menu_link">Research</a></li>
							<li><a href="http://decide.wegov.nyc/legislation/processes" class="menu_link">Decide</a></li>
							<li><a href="http://wegov.nyc/act/" class="menu_link">Act</a></li>
						</ul>
					</li>
					<li><a href="http://wegov.nyc/about/" class="menu_link">About</a></li>
					<li><a href="http://wegov.nyc/blog/" class="menu_link">Blog</a></li>
					<li><a href="https://opencollective.com/mygovnyc" class="menu_link">Donate</a></li>
					<li><a href="http://wegov.nyc/get-involved/" class="menu_link">Get Involved</a></li>
				</ul>
			</div>
		</div>
		<!-- end main menu area -->
